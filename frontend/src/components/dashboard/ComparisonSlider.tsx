...
interface ComparisonSliderProps {
  ...
  realBeforeUrl?: string | null;
  realAfterUrl?: string | null;
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full">
        {realAfterUrl ? (
          <img src={realAfterUrl} className="w-full h-full object-cover select-none pointer-events-none" alt="After scene" />
        ) : (
      ...
      >
        {realBeforeUrl ? (
          <img src={realBeforeUrl} className="w-full h-full object-cover select-none pointer-events-none" alt="Before scene" />
        ) : (
      ...
      {registrationWarning && (
        <div className="absolute top-14 left-1/2 -translate-x-1/2 bg-alert/90 border border-alert px-4 py-2 rounded text-xs font-mono text-white shadow-xl flex items-center gap-2 z-50 pointer-events-auto">
